...
<?php $__env->startSection('content'); ?>
    ...
    <div class="mb-4">
        <a href="/e-commerce" class="py-[10px] px-[15px] rounded-lg bg-blue-500 text-white">Back to home</a>
    </div>
    ...
    <script>
        $.ajax({
            ...
            success: response => {
                ...
                $('#nama').val(dataProduct.nama);
                $('#harga').val(dataProduct.harga);
                $('#diskon').val(dataProduct.diskon);
            }
        });

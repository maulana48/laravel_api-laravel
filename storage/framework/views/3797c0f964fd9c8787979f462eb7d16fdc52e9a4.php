...
<!-- component -->
	<div class="relative min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 bg-gray-500 bg-no-repeat bg-cover relative items-center"
		...
		<div class="sm:max-w-lg min-w-full p-10 bg-white rounded-xl z-10">
			...
			<form class="mt-8 space-y-3" action="<?php echo e(route('blog.update', $post->id)); ?>" method="POST" enctype="multipart/form-data">
			<?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="title" id="title" required autofocus value="<?php echo e(old('title', $post->title)); ?>">
...
unset($__errorArgs, $__bag); ?>" name="slug" id="slug" required autofocus value="<?php echo e(old('slug', $post->slug)); ?>">
						...
						<div class="grid grid-cols-1 space-y-2">
							<label for="user_id" class="text-sm font-bold text-gray-500 tracking-wide">Select User</label>
                                <select class="text-base p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500" name="user_id" id="user">
                                        <option value="<?php echo e($post->user->id); ?>" selected><?php echo e($post->user->name); ?></option>
                                </select>
						...
						<div class="grid grid-cols-1 space-y-2">
							<label for="category_id" class="text-sm font-bold text-gray-500 tracking-wide">Select Category</label>
                                <select class="text-base p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500" name="category_id" id="category">
                                        <option disabled <?php if(!old('category_id', $post->category_id)): ?> selected <?php endif; ?>> -- select an option -- </option>
...
unset($__errorArgs, $__bag); ?> name="body" id="body" required autofocus value="<?php echo e(old('body')); ?>"><?php echo e($post->body); ?></textarea>
...
<?php echo $__env->make('components.parent', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\New folder\Alkademi\Laravel\api-laravel\resources\views/Blogs/edit.blade.php ENDPATH**/ ?>
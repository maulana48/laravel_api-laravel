...
<div class="relative min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 bg-gray-500 bg-no-repeat bg-cover relative items-center"
	...
	<div class="sm:max-w-lg min-w-full p-10 bg-white rounded-xl z-10">
		...
		<form id="form" class="mt-8 space-y-3" action="{{ route('api-blog.store') }}" method="POST"
			...
			<div class="grid grid-cols-1 space-y-2">
				...
				<input
					...
					type="" placeholder="Insert post title" @error('title') is-invalid @enderror" name="title"
			...
			<div class="grid grid-cols-1 space-y-2">
				...
				<input
					class="text-base p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500"
					type="" placeholder="slug" @error('slug') is-invalid @enderror" name="slug" id="slug" required
			...
			<div class="grid grid-cols-1 space-y-2">
				...
				<textarea
					class="text-base p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500"
					type="text" placeholder="" @error('body') is-invalid @enderror name="body" id="body" required
					autofocus value="{{ old('body') }}"></textarea>
